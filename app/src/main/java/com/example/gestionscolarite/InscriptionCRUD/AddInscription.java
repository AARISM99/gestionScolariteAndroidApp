...
public class AddInscription extends AppCompatActivity {
    Button addBtn;
    ...
    DBHelper DBH = new DBHelper(AddInscription.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn = (Button) findViewById(R.id.addInscriptionBtn);
        date_inscription = (EditText) findViewById(R.id.date_inscription_input);
        ...
        spinnerNiveau = findViewById(R.id.niveau_inscription_select);
        spinnerFiliere = findViewById(R.id.filiere_inscription_select);
        spinnerEtudiant = findViewById(R.id.etudiant_inscription_select);
        ...
        spinnerNiveau.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(AddInscription.this,list_niveaux_ids.get(position)+ " Selected",Toast.LENGTH_LONG).show();
        ...
        spinnerFiliere.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(AddInscription.this,list_filieres_ids.get(position)+ " Selected",Toast.LENGTH_LONG).show();
        ...
        spinnerEtudiant.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(AddInscription.this,list_etudiants_ids.get(position)+ " Selected",Toast.LENGTH_LONG).show();
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DBH.insertInscription(I);
                Intent i = new Intent(AddInscription.this, ListInscription.class);
                startActivity(i);
            };
        });
    }
